...
//start script
			async function starts() {
				...
				console.log(color(figlet.textSync('kavee-Bot', {
					font: 'Standard',
				...
				haruka.on('qr', () => {
					console.log(color('[','white'), color('!','red'), color(']','white'), color('SCAN QR MASK 15 SECONDS, AND SUBSCRIBE YOUTUBE Kavee'))
					})
			...
			haruka.on('open', () => {
				console.log('|\x1b[1;32m TRM \x1b[1;37m|', color('Connected', 'red'))
			})
...
case 'menu': case 'help': case 'haruka':
				...
				break
case 'infobot':
reply('Update bot selanjutnya silahkan cek YouTube kavee')
break
case 'owner':{
